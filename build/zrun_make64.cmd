:: Gen: gen_vc.cmd -con -xp ..\src\zrun.cpp -x64 -link /out:..\bin\zrun64.exe
@echo off
setlocal
...
cl.exe /nologo kernel32.lib user32.lib shell32.lib advapi32.lib ole32.lib ..\src\zrun.cpp /link /nologo /out:..\bin\zrun64.exe
if ERRORLEVEL 1 goto :ERROR
del *.obj>nul
endlocal
exit 0
